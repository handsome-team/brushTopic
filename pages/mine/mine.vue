<template>
	<view class="mine-box">
		...
		<view class="nav-box">
			<view class="list-box" @click="toMean">
				<view class="background-box" style="background:#F7B940;">
					<image src="../../static/mine/service.png" mode=""></image>
				</view>
				<text>我的资料</text>
				<image src="../../static/mine/right.png" mode=""></image>
			</view>
			<view class="list-box" @click="toCollection">
				<view class="background-box" style="background: #FF5555;">
					<image src="../../static/mine/note.png" mode=""></image>
				</view>
				<text>我的收藏</text>
				<image src="../../static/mine/right.png" mode=""></image>
			</view>
			<view class="list-box" @click="changePassword">
				<view class="background-box" style="background:#C490BF;">
					<image src="../../static/mine/access.png" mode=""></image>
				</view>
				<text>修改密码</text>
				<image src="../../static/mine/right.png" />
			</view>
			<view class="list-box" @click="outlogin">
