	...
	<view class="homeContaienr">
		<view class="searchBoxCon">
			<view class="searchBox">
				<view class="searchImg">
					<image src="../../static/search/sousuo.png" mode=""></image>
				</view>
				<input type="text" v-model="inpvalue" value="" @click="goSearch" class="inp" placeholder="搜索您想要的内容" />
			</view>
		...
		<view class="swiperBox">
			<swiper class="swiper" :indicator-dots="indicatorDots" :autoplay="autoplay" :interval="interval" :duration="duration">
				<swiper-item v-for="item in bannerList" :key="item.id" class="swiperImg">
		...
		<view class="officialQuestion">
			...
			<view class="iconsBox">
				<view class="icons" v-for="item in iconList" :key='item.id' @click="switchPage(item.txt)">
					<image :src="item.url"></image>
					<text>{{item.txt}}</text>
				</view>
			</view>
		...
		<view class="hotFunction">
			...
			<view class="hotImg">
				<image src="../../static/index/hot1.png" mode=""></image>
				<image src="../../static/index/hot2.png" mode=""></image>
			</view>
		</view>
		<!-- 最新消息 -->
		<view class="hotNews">
			<p class="title">最新消息</p>
			<view class="newsbox" v-for="(item,index) in dataList[0]" :key='item.id' @tap='gonNwsdetail' :data-postid='item.post_id'>
